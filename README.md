...
### 辅助 Skills（1 个）
- **Development Workflow** - 通用软件开发流程（需求引导、设计方案、tasks 任务清单、直白文档模板、代码审查、CI/CD）
...
- 先写清为什么要做、这次做什么、不做什么、怎么验证
- 尽量使用直白表达，术语、缩写或英文词第一次出现要解释
- 模板按需裁剪，编号、追踪矩阵、关联文档等字段不是必填
- 面向非技术读者时，优先使用“需求、范围、影响、验证”这类词
...
- 补充文档写作规则：要求先写结论、控制术语密度，并默认面向不了解上下文的读者
- 优化需求、设计、tasks、ADR、评审模板标题，让读者更快看懂“做什么、为什么、怎么验证”
- 将编号、关联文档、追踪矩阵等字段调整为按需使用，降低轻量文档的填写成本
